...
/*!
 * @class template_javaComp
 * @brief Standalone component Class
 *
 */
public class template_javaComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(template_java.component_conf);
      mgr.registerFactory(prop, new template_java(), new template_java());

      // Create a component
      RTObject_impl comp = mgr.createComponent("template_java");
      if( comp==null ) {
...
//      }
    ...
    public static void main(String[] args) {
        ...
        template_javaComp init = new template_javaComp();
